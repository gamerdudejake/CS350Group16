...
public class Parser {
    ...
    public void getUserInput() {
        ...
        this.userInput = scanner.nextLine(); // TODO: remove comment after testing and remove below line
    ...
    public void actors() {
        ...
        if (this.words[1].equals("ship")) {
            ...
            // TODO: NICK - loop words 5+ into this.idN
            ...
            this.course = Integer.parseInt(this.words[11]);
        ...
        if (this.words[1].equals("munition") || this.words[3].equals("munition")) {
            ...
            switch(this.words[2]) {
                ...
                case "torpedo":
                    ...
                    this.id = this.words[3];
                    this.id2 = this.words[7];
                    this.id3 = this.words[9];
                ...
                case "missile":
                    ...
                    this.id2 = this.words[7];
                    this.id3 = this.words[9];
                    this.distance = Double.parseDouble(this.words[7]);
        ...
        if (this.words[1].equals("sensor")) {
            switch(this.words[2]) {
                ...
                case "time":
                    ...
                    this.id = this.words[3];
                    this.time = Integer.parseInt(this.words[7]);
        ...
        if (this.words[0].charAt(0) == '@'){
            switch(this.words[0]) {
                ...
                case "@force":
                    ...
                    this.id = this.words[1];
                    this.course = Integer.parseInt(this.words[4]);
